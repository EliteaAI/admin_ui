...
const AuditHeatmap = memo(function AuditHeatmap({
  data,
  metadata,
  isFetching,
  onCellClick,
    ...
    <Box sx={styles.container}>
      ...
      {metadata && (
        <Typography variant="caption" sx={styles.metaLabel}>
          {metadata.total_events ?? metadata.total_traces}{" "}
          {viewMode === "traces" ? "traces" : "events"} &middot;{" "}
          {metadata.interval_label} buckets
        </Typography>
      )}

  ...
  return (
    <Box sx={styles.root}>
      <Typography variant="body2" sx={styles.description}>
        Configure the trigger characters that activate mention dropdowns in chat
        and agent instructions. Each trigger must be a single non-alphanumeric
        character and must be unique. Changes require a browser refresh to take
        effect.
      </Typography>
      ...
      {TRIGGER_FIELDS.map((field) => {
        ...
        return (
          <Box key={field.key} sx={styles.fieldCard}>

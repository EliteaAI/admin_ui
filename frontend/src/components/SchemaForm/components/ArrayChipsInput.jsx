...
const ArrayChipsInput = memo(props => {
  const { value, onChange, suggestions, labels, placeholder } = props;

  const styles = arrayChipsInputStyles();

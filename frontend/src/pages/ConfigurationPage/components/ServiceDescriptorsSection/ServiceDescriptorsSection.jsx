...
} from '@/api/serviceDescriptors.api';
import { SearchIcon } from '@/components/Icons';

import ServiceDescriptorsTable from './components/ServiceDescriptorsTable';

const ServiceDescriptorsSection = memo(() => {
  const styles = serviceDescriptorsSectionStyles();
...
/** @type {MuiSx} */
const serviceDescriptorsSectionStyles = () => ({
  container: {
    display: 'flex',

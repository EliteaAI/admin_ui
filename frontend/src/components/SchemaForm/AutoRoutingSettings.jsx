  ...
  if (readError)
    return (
      <Alert severity="error">
        Administration admin access is required to manage Auto model selection.
      </Alert>
    );
  return (
    <Box sx={{ p: 3, display: "flex", flexDirection: "column", gap: 2 }}>
      ...
      <Typography variant="body2">
        Add Auto to model pickers for chats and ordinary agents. Pipeline model
        pickers keep explicit models.
      </Typography>
      <FormControlLabel
      ...
      <FormControlLabel
        ...
        control={
          <Switch
            ...
            disabled={
              !data?.can_manage || !data?.available || isFetching || isLoading
            }
      ...
      />
      <Typography variant="body2">
        Projects can override the default. Turning platform availability off
        blocks further Auto calls in every project. Calls already in flight
        can finish. Existing model selections are retained.
      </Typography>

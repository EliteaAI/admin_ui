...
import { useLazySecretRevealQuery } from '@/api/secrets.api';
import {
  GridTableBody,
  GridTableContainer,
  GridTableHeader,
...
const SecretsTable = memo(props => {
  ...
  const styles = useMemo(() => secretsTableStyles(), []);
  ...
  const renderActions = useCallback(
    ...
    [styles, revealedSecrets, isReadOnly, handleRevealToggle, onEdit, onDelete],
  );

  ...
  return (
    <Box sx={styles.root}>
      <Typography variant="caption" sx={styles.hint}>
        Upload a custom logo to replace the default Elitea logo in the sidebar,
        chat header, and favicon. Recommended: SVG or PNG with transparent
        background.
      </Typography>
        ...
        >
          {isUploading ? (
            ...
            <>
              ...
              <Typography variant="body2" sx={styles.dropText}>

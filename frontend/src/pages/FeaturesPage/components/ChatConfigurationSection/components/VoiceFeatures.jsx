...
const VoiceFeatures = memo(props => {
  ...
  const styles = voiceFeaturesStyles();
  ...
  return (
    <Box sx={styles.root}>
      ...
      >
        Control Voice-to-Voice, Text-to-Voice, and Voice-to-Text features environment-wide. These toggles
        apply to all three voice capabilities together.
      </Typography>
      ...
      <Box sx={styles.toggleCard}>
        <Box sx={styles.toggleRow}>
          <Box sx={styles.toggleLabel}>
            ...
            >
              When disabled, all voice buttons and icons are completely hidden for all users across the
              environment.
            </Typography>
          </Box>
          <Switch
        ...
        <Box sx={styles.toggleRow}>
          <Box sx={styles.toggleLabel}>
            ...
            <Typography
              ...
              sx={styles.toggleHint}
            >
              When enabled, voice buttons remain visible but are non-interactive. Users see a tooltip:

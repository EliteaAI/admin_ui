...
const SupportAssistant = memo(props => {
  ...
  const styles = supportAssistantStyles();
  ...
  return (
    <Box sx={styles.root}>
      ...
      >
        Enable the Support Assistant widget to provide users with an in-app AI-powered assistant for guidance
        and troubleshooting.
      </Typography>
        ...
        <Box sx={styles.cardRow}>
          <Box sx={styles.cardLabel}>
            ...
            <Typography
              ...
              sx={styles.cardHint}
            >
              When enabled, the support assistant widget is available to all users environment-wide
            </Typography>
          </Box>
          <Switch
            checked={enabled}
        ...
        <Box sx={styles.cardRow}>
          <Box sx={[styles.cardLabel, { width: '100%' }]}>
            ...
            <Typography
              ...
              sx={styles.cardHint}
            >
              Project ID used for support conversations. Auto-created if left empty.
            </Typography>
            <TextField
              size="small"
              type="number"

...
const MapEditor = memo(({ value, onChange, keySuggestions, valueSuggestionsSource }) => {
...
const MapEntryRow = memo(({ entryKey, vals, valueSuggestionsSource, onDelete, onValuesChange }) => {

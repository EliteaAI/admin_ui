...
import { useUserBudgetListQuery } from '@/api/budgets.api';
import { GridTablePagination } from '@/components/GridTable';
import { useDebounceValue } from '@/hooks/useDebounceValue.hooks';
import { formatLimit, formatMoney, usageColor } from '@/pages/BudgetsPage/helpers/budgetFormat.helpers';
 ...
 */
const UserBudgetsDrawer = memo(props => {
  const { open, onClose, project, canEdit, onEdit } = props;

  const styles = userBudgetsDrawerStyles();
...
UserBudgetsDrawer.displayName = 'UserBudgetsDrawer';

/** @type {MuiSx} */
const userBudgetsDrawerStyles = () => ({
  paper: {
...
export default UserBudgetsDrawer;

...
const UserActivityDrawer = memo(props => {
  const { open, onClose, user } = props;

  const styles = userActivityDrawerStyles();
...
UserActivityDrawer.displayName = 'UserActivityDrawer';

/** @type {MuiSx} */
const userActivityDrawerStyles = () => ({
  drawer: {
    '& .MuiDrawer-paper': {
      width: '75vw',
      maxWidth: '75vw',

...
import { useModelPriceCreateMutation, useModelPriceUpdateMutation } from '@/api/modelPrices.api';
import { MODEL_MODES, PRICE_FIELDS } from '@/pages/ModelPricesPage/constants/modelPrices.constants';
import { fromPerMillion, toPerMillion } from '@/pages/ModelPricesPage/helpers/modelPrices.helpers';
...
const ModelPriceDialog = memo(props => {
  const { open, target, onClose, onSaved } = props;

  const styles = modelPriceDialogStyles();
...
ModelPriceDialog.displayName = 'ModelPriceDialog';

/** @type {MuiSx} */
const modelPriceDialogStyles = () => ({
  row: {
    display: 'flex',
    gap: '1rem',
  },

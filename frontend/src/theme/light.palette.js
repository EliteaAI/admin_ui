import { darkBlue, white } from './dark.palette';
...
const blue01 = 'rgba(248, 252, 255, 1)';
...
const lightPalette = {
  ...
  background: {
    ...
    paginationHover: 'rgba(255, 255, 255, 0.1)',
    subtle: {
      faint: 'rgba(0, 0, 0, 0.01)',
    ...
    socketIndicator: {
      connected: green,
      disconnected: dangerRed,
    },
    overlay: {
      default: 'rgba(0, 0, 0, 0.04)',
      strong: 'rgba(0,0,0,0.05)',
    },
    deprecated: orange10,
    mcp: {
      loginSuccess: green8,
  ...
  boxShadow: {
    ...
    floating: '0 1px 4px rgba(0,0,0,0.15)',
    popover: '0 2px 8px rgba(0,0,0,0.15)',
  },
  text: {
    default: light10,
    primary: light10,

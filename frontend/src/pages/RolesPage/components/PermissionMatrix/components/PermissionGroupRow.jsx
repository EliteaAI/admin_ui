...
const PermissionGroupRow = memo(props => {
  const {
    groupName,
    permissions,
    roles,
  ...
  const styles = permissionGroupRowStyles();
...
PermissionGroupRow.displayName = 'PermissionGroupRow';

/** @type {MuiSx} */
const permissionGroupRowStyles = () => ({
  row: ({ palette }) => ({
    display: 'grid',

  ...
  return (
    <Box sx={styles.root}>
      <Typography variant="body2" sx={styles.description}>
        ...
        Administrators will bypass the splash and can continue using the
        platform normally.
      </Typography>
      ...
      <Box sx={styles.editorCard}>
        <Box sx={styles.editorHeader}>
          ...
          <Typography variant="caption" sx={styles.editorHint}>
            Custom HTML shown during maintenance. Leave empty to use the default
            template.
          </Typography>
        </Box>

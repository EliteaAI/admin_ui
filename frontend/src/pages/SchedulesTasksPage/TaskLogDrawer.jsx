...
const TaskLogDrawer = memo(function TaskLogDrawer({ open, taskId, taskMeta, onClose }) {
    ...
    <Drawer anchor="right" open={open} onClose={onClose} sx={styles.drawer}>
      <Box sx={styles.root}>
        ...
        {taskMeta && (
          <Box sx={styles.metaBar}>
            ...
            {isFinished && countdown > 0 && (
              <Typography variant="body2" color="text.metrics" sx={styles.countdownText}>
        ...
        <Box sx={styles.toolbar}>
          <Typography variant="body2" color="text.metrics" sx={styles.lineCount}>
            {hasLogs ? `${logs.length} line${logs.length !== 1 ? 's' : ''}` : 'No output'}
          </Typography>
          <Box sx={styles.toolbarActions}>
            <Tooltip title="Scroll to top">
              <span>
                <IconButton size="small" onClick={handleScrollTop} disabled={!hasLogs}>
            ...
            <Tooltip title="Scroll to bottom">
              <span>
                <IconButton size="small" onClick={handleScrollBottom} disabled={!hasLogs}>
            ...
            <Tooltip title="Download logs">
              <span>
                <IconButton size="small" onClick={handleDownload} disabled={!hasLogs}>

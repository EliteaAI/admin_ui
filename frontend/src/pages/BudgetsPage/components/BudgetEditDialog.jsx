...
import { formatLimit, formatMoney } from '@/pages/BudgetsPage/helpers/budgetFormat.helpers';
 ...
 */
const BudgetEditDialog = memo(props => {
  const { open, onClose, onSave, target, isSaving } = props;

  const styles = budgetEditDialogStyles();
...
BudgetEditDialog.displayName = 'BudgetEditDialog';

/** @type {MuiSx} */
const budgetEditDialogStyles = () => ({
  content: {
    display: 'flex',

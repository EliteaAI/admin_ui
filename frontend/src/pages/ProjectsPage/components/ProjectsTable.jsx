...
const ProjectsTable = memo(props => {
  const {
    projects = [],
    total = 0,
    page = 0,
  ...
  const styles = useMemo(() => projectsTableStyles(), []);
  ...
  const renderActions = useCallback(
    ...
    [styles, onDelete, onAddAdmin, onSuspend, onActivity, onBackup, onRestore],
  );
